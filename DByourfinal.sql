...
TITLE VARCHAR2(100) NOT NULL, --클래스 이름
...
TITLE VARCHAR2(200) NOT NULL, --글의 제목
...
VISIT_ID VARCHAR2(50) NOT NULL, -- 주문자 아이디
VISIT_IP VARCHAR2(100) NOT NULL,  --주문번호
);
...
VISIT_IP VARCHAR2(50) NOT NULL, 
VISIT_AGENT VARCHAR2(100) NOT NULL 
);
